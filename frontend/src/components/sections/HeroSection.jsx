...
export default function HeroSection() {
  return (
    <div className="bg-gradient-to-b from-white via-gray-50 to-white text-black">
      {/* Hero Content */}
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 pt-6 sm:pt-20 pb-6 sm:pb-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-12 items-center">
          ...
          <div className="space-y-4 sm:space-y-8">
            <div className="space-y-2 sm:space-y-4">
              ...
              <p className="text-xs sm:text-base lg:text-lg text-gray-600 max-w-lg leading-relaxed">
                Discover our curated collection of premium products with unbeatable prices. Shop with confidence and enjoy fast delivery.
              </p>
            </div>

            {/* CTA Buttons */}
            <div className="flex flex-col sm:flex-row gap-2 sm:gap-4 pt-2 sm:pt-8">
              <Link to="/shop" className="w-full sm:w-auto">
                <Button size="lg" className="w-full text-xs sm:text-base px-4 sm:px-8 py-2.5 sm:py-3">
                  <ShoppingCart className="mr-2 h-3 sm:h-5 w-3 sm:w-5" />
                  Start Shopping
                </Button>
              </Link>
              <Link to="/shop" className="w-full sm:w-auto">
                <Button 
                  size="lg" 
                  variant="outline" 
                  className="w-full text-xs sm:text-base px-4 sm:px-8 py-2.5 sm:py-3 border-gray-400 hover:bg-gray-100"
                >
                  Browse Catalog
                </Button>
              </Link>
            ...
            {/* Stats */}
            <div className="grid grid-cols-3 gap-2 sm:gap-6 pt-4 sm:pt-8 border-t border-gray-300">
              <div>
                <p className="text-lg sm:text-3xl font-bold text-black">10K+</p>
                <p className="text-gray-600 text-xs sm:text-sm">Products</p>
              </div>
              <div>
                <p className="text-lg sm:text-3xl font-bold text-black">50K+</p>
                <p className="text-gray-600 text-xs sm:text-sm">Happy Customers</p>
              </div>
              <div>
                <p className="text-lg sm:text-3xl font-bold text-black">24/7</p>
